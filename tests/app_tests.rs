//! Application-level tests for slirc-client.
//!
...
fn create_test_app() -> (
    ...
    let app = SlircApp {
        state,
        connection: slirc_client::config::ConnectionConfig {
        ...
        action_tx,
        event_rx,
        input: slirc_client::input_state::InputState::new(),
        ...
        show_user_list: true,
        quick_switcher: slirc_client::ui::quick_switcher::QuickSwitcher::default(),
        // Dialogs - managed centrally by DialogManager
        dialogs: slirc_client::dialog_manager::DialogManager::new(),
        // Keyboard shortcuts
        shortcuts: slirc_client::ui::shortcuts::ShortcutRegistry::new(),
...
fn test_notice_message_type() {
    use slirc_client::buffer::MessageType;
    let (mut app, event_tx, _) = create_test_app();
